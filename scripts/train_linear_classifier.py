...
if __name__ == '__main__':
    ...
    experiment_name = "cpcv1-cifar10-exp-1-linear-1"
    save_period_epochs = 2


    ss_checkpoint_path = f'{checkpoints_dir}/best_model_cifar10_resnet50v1.pth'
    num_classes = 100
    ...
    classifier_checkpoint_path = f'{checkpoints_dir}/best_model_resnetv1_cpcv1-cifar10-exp-1-linear-1.pth'
